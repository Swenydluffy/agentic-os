...
const NAV: NavItem[] = [
  ...
  { id: "omi", label: "NeuroSync", icon: Brain, accent: "#2dd4bf" },
  { id: "paperclip", label: "Paperclip", icon: Building2, accent: "#22e2ff" },
  { id: "obsidian", label: "Obsidian",    icon: BookOpen,    accent: "#7c3aed" },
...
export function Sidebar({
  ...
  const dotClass = health === null
    ? "pulse-dot"           // loading — default pulse
    : health.ok
      ? "pulse-dot"         // all green — normal pulse
      : "pulse-dot-warn";   // something down — warning pulse
